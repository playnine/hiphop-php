...
public:
  ...
  bool stgv_bool[13];
  #define run_pm_php$$classes$$arrayaccess$_php stgv_bool[0]
  #define run_pm_php$$classes$$closure$_php stgv_bool[1]
  #define run_pm_php$$classes$$debugger$_php stgv_bool[2]
  #define run_pm_php$$classes$$directory$_php stgv_bool[3]
  #define run_pm_php$$classes$$exception$_php stgv_bool[4]
  #define run_pm_php$$classes$$iterator$_php stgv_bool[5]
  #define run_pm_php$$classes$$reflection$_php stgv_bool[6]
  #define run_pm_php$$classes$$splfile$_php stgv_bool[7]
  #define run_pm_php$$classes$$splobjectstorage$_php stgv_bool[8]
  #define run_pm_php$$classes$$stdclass$_php stgv_bool[9]
  #define run_pm_php$$classes$$xhprof$_php stgv_bool[10]
  #define run_pm_php$$globals$$constants$_php stgv_bool[11]
  #define run_pm_php$$globals$$symbols$_php stgv_bool[12]
};
